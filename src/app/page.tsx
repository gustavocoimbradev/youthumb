        ...
        {!isSubmited ? (
          <Card className="!p-0">
            <div className="flex flex-row items-center h-[120px] relative">
              ...
              <div className="animate-color-change-1 w-full h-full hidden md:block"></div>
              <div className="animate-color-change-2 w-full h-full hidden md:block"></div> 
              {latestThumbnails.length > 0 ? (
                  <div className="absolute flex flex-row items-center justify-between animate-fade-in">
